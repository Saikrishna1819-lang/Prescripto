    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <div className='flex flex-col gap-4 text-sm text-gray-600'>
          ...
          <p onClick={()=> speciality==='Pediatricians'? navigate('/doctors') :navigate('/doctors/Pediatricians')} className={`w-[94vh] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointe ${speciality==="Pediatricians" ? "bg-indigo-100 text-black":""}`}>Pediatricians</p>
