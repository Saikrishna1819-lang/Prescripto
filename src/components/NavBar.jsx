    ...
    <div className='flex justify-between items-center text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <ul className='hidden md:flex items-start gap-5 font-medium '>
            ...
            <NavLink to="/about">
                ...
                <hr className='border-none  hidden outline-none h-0.5 bg-primary w-3/5 m-auto'></hr>
            </NavLink>
            <NavLink to="/contact">
                <li className="py-1">CONTACT</li>
               <hr className='border-none outline-none hidden h-0.5 bg-primary w-3/5 m-auto'></hr>
            </NavLink>
        </ul>
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                         <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            <p onClick={()=>{navigate("my-profile")}}  onClickclassName="hover:text-black cursor-pointer">My Profile</p>
